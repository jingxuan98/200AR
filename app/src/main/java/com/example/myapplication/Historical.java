...
public class Historical extends AppCompatActivity implements Scene.OnUpdateListener {
    ...
    public void setupDatabase(Config config, Session session) {
        Bitmap foxBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.historicalimg);
